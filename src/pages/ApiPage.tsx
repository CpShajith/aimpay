    ...
    return (
        <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <button
                        ...
                        className="px-6 py-3 bg-orange-600 hover:bg-orange-500 text-white font-medium rounded-xl transition-colors flex items-center gap-2"
                    >
                        <Terminal className="w-5 h-5" /> Get API Keys
                    </button>
                    <button
                        onClick={() => navigate('/contact')}
                        className="px-6 py-3 bg-transparent border border-orange-700 hover:border-orange-500 text-orange-200 font-medium rounded-xl transition-colors"
                    >
                        Read Docs
                    </button>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <motion.div
                    className="bg-gray-50 border border-gray-200 rounded-2xl overflow-hidden shadow-2xl shadow-gray-200/50"
                ...
                >
                    ...
                    <div className="p-6 overflow-x-auto text-sm font-mono text-gray-500">
                        <pre><code>
                ...
                >
                    <div className="flex gap-4 items-start">
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Idempotent Requests</h3>
                    ...
                    <div className="flex gap-4 items-start">
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Real-Time Webhooks</h3>
                            <p className="text-gray-500 leading-relaxed">
                    ...
                    <div className="flex gap-4 items-start">
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">High Availability</h3>
                            <p className="text-gray-500 leading-relaxed">
