  ...
  return (
    ...
    >
      <motion.div
        ...
        whileHover={{ scale: 1.02, borderColor: 'rgba(247, 59, 32, 0.3)' }}
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-start justify-between mb-8">
            <motion.div
              className={`w-16 h-16 bg-gradient-to-br ${card.gradient} rounded-2xl flex items-center justify-center shadow-md`}
            ...
            <div className="text-right">
              <motion.div
                className="text-5xl bg-gradient-to-br from-orange-500 to-orange-600 bg-clip-text text-transparent mb-1 font-bold"
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
                viewport={{ once: true }}
              ...
              <div className="text-sm text-gray-400 font-medium">{card.statLabel}</div>
            </div>
          </div>

          <h3 className="text-3xl text-gray-900 font-semibold mb-4">{card.title}</h3>
          <p className="text-base sm:text-lg text-gray-500 leading-relaxed">{card.description}</p>
